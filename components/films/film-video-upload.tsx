...
export function FilmVideoUpload({
  ...
  return (
    <section className="app-stack-card rounded-[22px] border border-white/10 bg-white/5 p-3.5 sm:rounded-[24px] sm:p-6">
      <div className="app-grid-safe flex flex-col gap-3.5 sm:gap-4 lg:flex-row lg:items-start lg:justify-between">
