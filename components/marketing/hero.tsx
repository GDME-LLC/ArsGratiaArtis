  ...
  return (
    <section className="container-shell pt-4 sm:pt-6 lg:pt-7" data-reveal="hero">
      <div className="surface-panel cinema-frame relative overflow-hidden px-5 py-6 sm:px-8 sm:py-8 lg:px-11 lg:py-10">
        <HeroBackgroundVideo />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_18%,rgba(255,255,255,0.1),transparent_18%),radial-gradient(circle_at_72%_14%,rgba(199,166,106,0.12),transparent_22%),linear-gradient(135deg,rgba(9,10,18,0.18),rgba(9,10,18,0.62))]" />
        ...
        <div className="absolute inset-y-8 right-5 hidden w-[29%] rounded-[26px] border border-white/10 bg-[linear-gradient(180deg,rgba(13,13,20,0.76),rgba(7,7,11,0.42))] p-3 shadow-[0_30px_100px_rgba(0,0,0,0.42)] backdrop-blur-sm lg:block">
          {spotlightFilm ? (
            <Link href={`/film/${spotlightFilm.slug}`} className="block h-full transition duration-500 hover:translate-y-[-2px] hover:scale-[1.01]">
              <div className="flex h-full flex-col justify-between rounded-[21px] border border-white/10 bg-black/30 p-4">
                <div>
        ...
        <div className="relative max-w-3xl lg:max-w-[58%]">
          <div className="rounded-[24px] border border-white/10 bg-black/18 p-4 shadow-[0_18px_60px_rgba(0,0,0,0.18)] backdrop-blur-[2px] sm:p-5">
          ...
          <div className="mt-5 grid gap-3 border-t border-white/10 pt-4 sm:grid-cols-3" data-reveal="hero-panels">
            <div className="space-y-2 rounded-[20px] border border-white/10 bg-black/22 p-3.5 backdrop-blur-[2px] sm:p-4">
