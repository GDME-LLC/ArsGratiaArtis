...
export function HeroBackgroundVideo() {
  ...
  return (
    <div ref={containerRef} className="absolute inset-0 z-0 overflow-hidden" aria-hidden="true">
      ...
      >
        <div
          className={`absolute inset-0 translate-y-[11vh] scale-[1.12] bg-cover bg-center bg-no-repeat transition-opacity duration-[560ms] ease-out sm:scale-[1.1] lg:scale-[1.08] xl:bg-[position:24%_center] ${hasReadyVideo && !prefersReducedMotion ? "opacity-10" : "opacity-64"}`}
