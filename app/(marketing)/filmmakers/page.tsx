  ...
  return (
    <SectionShell className="py-14 sm:py-16">
      <PageIntro
        ...
        description="A growing roster of filmmakers publishing on ArsGratia. Discover voices, styles, and releases across the platform."
      />
          ...
          {creators.map((creator) => {
            ...
            return (
              ...
              <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
                ...
                <div className="rounded-[22px] border border-white/10 bg-black/20 px-4 py-3 text-sm text-muted-foreground md:min-w-[190px]">
                  <p className="display-kicker">Creator status</p>
                  <p className="mt-2 text-foreground">{creator.isCreator ? "Filmmaker" : "Creator"}</p>
                  <p className="mt-3">{creator.followerCount} follower{creator.followerCount === 1 ? "" : "s"}</p>
                </div>
              </div>
