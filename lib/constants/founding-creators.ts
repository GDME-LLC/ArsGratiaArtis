...
export const foundingCreatorBenefits = [
  ...
  "Permanent recognition as one of the first 20 creators",
] as const;

export const foundingCreatorMonetizationNote =
  "Monetization features are planned and will launch in phases. Founding Creators will receive priority access to those tools as they become available.";
